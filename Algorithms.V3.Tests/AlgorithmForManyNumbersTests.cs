...
namespace Algorithms.V3.Tests
{
    ...
    {
        private readonly AlgorithmForManyNumbers euclidian = new AlgorithmForManyNumbers(new EuclidianAlgorithm());
        private readonly AlgorithmForManyNumbers stein = new AlgorithmForManyNumbers(new SteinsAlgorithm());
